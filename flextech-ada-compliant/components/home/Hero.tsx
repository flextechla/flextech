      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          <div className="relative w-full aspect-square max-w-[480px] mx-auto">
            ...
            {/* Center Icon */}
            <div className="absolute inset-[35%] bg-brand-card border border-brand-accent/15 rounded-3xl flex items-center justify-center text-5xl shadow-[0_0_60px_rgba(0,212,170,0.2)]" aria-hidden="true">
              🛡️
            </div>
